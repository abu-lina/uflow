...
/**
 * Not found page for community services section
 * Displays when a community service ID doesn't exist in the database
 */
export default function CommunityServiceNotFound() {
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="text-center">
        ...
        <h1 className="mb-2 text-3xl font-bold text-gray-900">Service nicht gefunden</h1>

        <p className="mb-8 text-lg text-gray-600">
          Der gesuchte Community-Service existiert nicht oder wurde entfernt.
        </p>
