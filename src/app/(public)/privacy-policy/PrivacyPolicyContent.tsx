...
export function PrivacyPolicyContent() {
  ...
  const content: Record<string, Record<string, string>> = {
    en: {
      ...
      intro:
        'We take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your personal data in accordance with the General Data Protection Regulation (GDPR).',

      dataController: 'Data Controller',
      dataControllerText:
        'Ummah Flow is the data controller responsible for your personal data. For any questions about this Privacy Policy or your data, please contact us at support@ummahflow.com.',
      ...
      dataLocationText:
        'Your personal data is stored and processed within the European Union (EU):',
      dataLocationList:
        '• Application servers: Hetzner Cloud, Germany\n• Database: Supabase, EU region\n• CDN: Cloudflare (prioritizes EU data centers)',
      ...
      userRightsExport:
        'To exercise your right to data portability, you can download your data from your profile settings.',
      ...
      changesText:
        'We may update this Privacy Policy from time to time. We will notify you of any material changes by email or through our platform. The "Last updated" date at the top indicates when this policy was last revised.',

      contact: 'Contact Us',
      contactText:
        'If you have questions about this Privacy Policy or wish to exercise your rights, please contact us at support@ummahflow.com.',
    },
    de: {
      ...
      dataControllerText:
        'Ummah Flow ist der für Ihre persönlichen Daten verantwortliche Datencontroller. Bei Fragen zu dieser Datenschutzrichtlinie oder Ihren Daten kontaktieren Sie uns bitte unter support@ummahflow.com.',
      ...
      contactText:
        'Wenn Sie Fragen zu dieser Datenschutzrichtlinie haben oder Ihre Rechte ausüben möchten, kontaktieren Sie uns bitte unter support@ummahflow.com.',
    },
    ar: {
      title: 'سياسة الخصوصية',
      lastUpdated: 'آخر تحديث: ديسمبر 2024',
      intro:
        'نحن نأخذ خصوصيتك على محمل الجد. توضح سياسة الخصوصية هذه كيفية جمع واستخدام وحماية بياناتك الشخصية وفقًا للائحة العامة لحماية البيانات (GDPR).',

      dataController: 'مسؤول البيانات',
      dataControllerText:
        'Ummah Flow هو مسؤول البيانات المسؤول عن بياناتك الشخصية. لأي أسئلة حول سياسة الخصوصية هذه أو بياناتك، يرجى الاتصال بنا على support@ummahflow.com.',

      dataCollection: 'جمع البيانات',
      dataCollectionText: 'نجمع البيانات الشخصية التالية:',
      dataCollectionList:
        '• عنوان البريد الإلكتروني (مطلوب لإنشاء الحساب والمصادقة)\n• الاسم (مقدم منك)\n• المحتوى الذي ينشئه المستخدم (مقدمي الخدمات، الإشارات المرجعية، التوصيات)\n• تفضيل اللغة (لتوفير محتوى محلي)\n• عنوان IP ووكيل المستخدم (لأغراض الأمان والتدقيق)',

      legalBasis: 'الأساس القانوني للمعالجة',
      legalBasisText: 'نقوم بمعالجة بياناتك الشخصية على أساس:',
      legalBasisList:
        '• تنفيذ العقد: لتقديم خدماتنا والوفاء بشروط الخدمة\n• المصلحة المشروعة: لضمان أمان المنصة ومنع الاحتيال\n• الموافقة: للميزات الاختيارية وأنشطة معالجة البيانات',
      ...
      userRightsExport:
        'لممارسة حقك في قابلية نقل البيانات، يمكنك تنزيل بياناتك من إعدادات الملف الشخصي.',
      ...
      cookiesList:
        '• ملفات تعريف الارتباط للمصادقة (مطلوبة لتسجيل الدخول)\n\nلا نستخدم ملفات تعريف الارتباط للتتبع أو التحليلات أو الإعلانات أو التفضيلات.',

      changes: 'التغييرات على هذه السياسة',
      changesText:
        'قد نحدث سياسة الخصوصية هذه من وقت لآخر. سنخطرك بأي تغييرات جوهرية عبر البريد الإلكتروني أو من خلال منصتنا. يشير تاريخ "آخر تحديث" في الأعلى إلى آخر مراجعة لهذه السياسة.',

      contact: 'اتصل بنا',
      contactText:
        'إذا كان لديك أسئلة حول سياسة الخصوصية هذه أو ترغب في ممارسة حقوقك، يرجى الاتصال بنا على support@ummahflow.com.',
    },
    tr: {
      title: 'Gizlilik Politikası',
      lastUpdated: 'Son güncelleme: Aralık 2024',
      intro:
        'Gizliliğinizi ciddiye alıyoruz. Bu Gizlilik Politikası, Genel Veri Koruma Yönetmeliği (GDPR) uyarınca kişisel verilerinizi nasıl topladığımızı, kullandığımızı ve koruduğumuzu açıklar.',

      dataController: 'Veri Sorumlusu',
      dataControllerText:
        'Ummah Flow, kişisel verilerinizden sorumlu veri sorumlusudur. Bu Gizlilik Politikası veya verileriniz hakkında sorularınız için lütfen support@ummahflow.com adresinden bizimle iletişime geçin.',

      dataCollection: 'Veri Toplama',
      dataCollectionText: 'Aşağıdaki kişisel verileri topluyoruz:',
      dataCollectionList:
        '• E-posta adresi (hesap oluşturma ve kimlik doğrulama için gerekli)\n• İsim (sizin tarafınızdan sağlanan)\n• Kullanıcı tarafından oluşturulan içerik (sağlayıcılar, yer imleri, öneriler)\n• Dil tercihi (yerelleştirilmiş içerik sağlamak için)\n• IP adresi ve kullanıcı aracısı (güvenlik ve denetim amaçları için)',

      legalBasis: 'İşleme Hukuki Dayanağı',
      legalBasisText: 'Kişisel verilerinizi şu temellere dayanarak işliyoruz:',
      legalBasisList:
        '• Sözleşme performansı: Hizmetlerimizi sağlamak ve hizmet şartlarımızı yerine getirmek için\n• Meşru menfaat: Platform güvenliğini sağlamak ve dolandırıcılığı önlemek için\n• Onay: İsteğe bağlı özellikler ve veri işleme faaliyetleri için',
      ...
      cookiesList:
        '• Kimlik doğrulama çerezleri (giriş için gerekli)\n\nİzleme çerezleri, analitik çerezler, reklam çerezleri veya tercih çerezleri kullanmıyoruz.',

      changes: 'Bu Politikadaki Değişiklikler',
      changesText:
        'Bu Gizlilik Politikasını zaman zaman güncelleyebiliriz. Önemli değişiklikler hakkında size e-posta veya platformumuz aracılığıyla bildirimde bulunacağız. Üstteki "Son güncelleme" tarihi, bu politikanın son ne zaman gözden geçirildiğini gösterir.',

      contact: 'Bize Ulaşın',
      contactText:
        'Bu Gizlilik Politikası hakkında sorularınız varsa veya haklarınızı kullanmak istiyorsanız, lütfen support@ummahflow.com adresinden bizimle iletişime geçin.',
    },
  };
        ...
        <ContentSection>
          <div className="prose prose-sm max-w-none">
            ...
            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.dataController}
            </h2>
            <p className="mb-6 text-base leading-6 text-content">
              {langContent.dataControllerText}
            </p>

            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.dataCollection}
            </h2>
            <p className="mb-4 text-base leading-6 text-content">
              {langContent.dataCollectionText}
            </p>
            ...
            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.legalBasis}
            </h2>
            <p className="mb-4 text-base leading-6 text-content">{langContent.legalBasisText}</p>
            <ul className="mb-6 list-inside list-disc space-y-2 rounded-lg bg-neutral-muted p-4 text-base text-content">
              {renderList(langContent.legalBasisList)}
            </ul>

            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.dataProcessing}
            </h2>
            <p className="mb-4 text-base leading-6 text-content">
              {langContent.dataProcessingText}
            </p>
            <ul className="mb-6 list-inside list-disc space-y-2 rounded-lg bg-neutral-muted p-4 text-base text-content">
            ...
            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.thirdParty}
            </h2>
            <p className="mb-4 text-base leading-6 text-content">{langContent.thirdPartyText}</p>
            <ul className="mb-4 list-inside list-disc space-y-2 rounded-lg bg-neutral-muted p-4 text-base text-content">
              {renderList(langContent.thirdPartyList)}
            </ul>
            <p className="mb-6 text-base italic leading-6 text-content-muted">
              {langContent.thirdPartyNote}
            </p>

            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.dataLocation}
            </h2>
            <p className="mb-4 text-base leading-6 text-content">{langContent.dataLocationText}</p>
            <ul className="mb-6 list-inside list-disc space-y-2 rounded-lg bg-neutral-muted p-4 text-base text-content">
              {renderList(langContent.dataLocationList)}
            </ul>

            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.userRights}
            </h2>
            <p className="mb-4 text-base leading-6 text-content">{langContent.userRightsText}</p>
            <ul className="mb-4 list-inside list-disc space-y-2 rounded-lg bg-neutral-muted p-4 text-base text-content">
              {renderList(langContent.userRightsList)}
            </ul>
            <p className="mb-6 text-base leading-6 text-content">{langContent.userRightsExport}</p>

            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.dataRetention}
            </h2>
            <p className="mb-4 text-base leading-6 text-content">{langContent.dataRetentionText}</p>
            <ul className="mb-6 list-inside list-disc space-y-2 rounded-lg bg-neutral-muted p-4 text-base text-content">
              {renderList(langContent.dataRetentionList)}
            </ul>

            <h2 className="mb-4 mt-8 text-lg font-semibold text-content-heading">
              {langContent.security}
            </h2>
            <p className="mb-4 text-base leading-6 text-content">{langContent.securityText}</p>
            <ul className="mb-6 list-inside list-disc space-y-2 rounded-lg bg-neutral-muted p-4 text-base text-content">
            ...
            <p className="mb-4 text-base leading-6 text-content">{langContent.cookiesText}</p>
            <div className="mb-6 rounded-lg bg-neutral-muted p-4">
              {(() => {
                ...
                return (
                  <>
                    <ul className="list-inside list-disc space-y-2 text-base text-content">
                      {renderList(listItems)}
                    </ul>
                    {additionalText && (
                      <p className="mt-4 text-base leading-6 text-content">
                        {additionalText.trim()}
                      </p>
                    )}
                  </>
