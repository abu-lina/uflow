...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-background">
      <header className="fixed left-0 right-0 top-0 z-50 pt-[calc(env(safe-area-inset-top)+16px)] sm:pt-[calc(env(safe-area-inset-top)+24px)] pb-2 bg-background border-b border-transparent isolate -mx-px px-px">
