        ...
        className={`${
          isUser
            ...
            : isTool
              ...
              : 'text-neutral-800 max-w-full px-2'
        }`}
      >
        {content && (
          <div className="text-sm whitespace-pre-wrap prose prose-sm max-w-none prose-p:my-0 prose-li:my-0 prose-ul:my-0 prose-ol:my-0 [&_li]:!my-0">
