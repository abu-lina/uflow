...
export function SuggestionCard({ icon, title, subtitle, onClick, disabled, className }: SuggestionCardProps) {
  return (
    <button
      className={cn('flex items-center gap-4 text-left w-full', disabled && 'pointer-events-none opacity-50', className)}
      disabled={disabled}
      onClick={onClick}
    >
