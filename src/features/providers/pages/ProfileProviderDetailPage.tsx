...
export const ProfileProviderDetailPage: React.FC<ProfileProviderDetailPageProps> = ({
  ...
  return (
    <>
      <div className="h-screen-fix hidden items-center justify-center md:flex">
        <span className="text-lg text-gray-500">
          Bitte nutze die Mobile-Ansicht für die Detailansicht.
        </span>
      </div>
      <div className="h-screen-fix relative flex w-full flex-col bg-gradient-to-b from-[#F5F5F5] to-[#FBFBFB] md:hidden">
        {/* Header */}
