...
export function Skeleton({ className, variant = 'text', size = 'md', ...props }: SkeletonProps) {
...
Skeleton.Circle = function SkeletonCircle({ className, ...props }: Omit<SkeletonProps, 'variant'>) {
  return <Skeleton className={className} variant="circle" {...props} />;
};

Skeleton.Rect = function SkeletonRect({ className, ...props }: Omit<SkeletonProps, 'variant'>) {
  return <Skeleton className={className} variant="rect" {...props} />;
};

Skeleton.Card = function SkeletonCard({ className, ...props }: Omit<SkeletonProps, 'variant'>) {
  return <Skeleton className={className} variant="card" {...props} />;
};
