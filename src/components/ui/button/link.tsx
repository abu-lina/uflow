      ...
      <Link
        ...
        className={cn(
          ...
          'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
          {
            ...
            'bg-action hover:bg-action/90 text-white': variant === 'action',
            'border-gray-light border bg-white hover:bg-gray-50':
              variant === 'search' || variant === 'location',
          },
          {
            // Base sizes
        ...
        href={href}
      >
        <span className={cn('text-base font-medium', 'text-foreground', 'flex items-center')}>
          {children}
        </span>
      </Link>
    );
