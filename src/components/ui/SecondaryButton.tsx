...
const secondaryButtonVariants = cva(
  'inline-flex items-center justify-center font-inter-tight text-base font-medium rounded-xl border transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        text: 'bg-transparent border-border text-content-muted hover:text-content hover:bg-neutral-50',
        'with-icon': 'bg-transparent border-border text-content-muted hover:text-content hover:bg-neutral-50 gap-2',
      },
      size: {
