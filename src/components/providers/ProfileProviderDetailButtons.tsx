  ...
  return (
    <>
      ...
      <div className="relative flex-1">
        <button
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-300 py-3 px-6 font-inter-tight font-medium text-gray-700 hover:bg-gray-50 transition-colors"
          onClick={() => setShowActionsMenu(true)}
        >
