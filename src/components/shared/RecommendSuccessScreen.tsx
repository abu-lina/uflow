...
// Verification inputs as they were just submitted. The seal tier is derived
// with the same computeSealTier used on the provider detail page.
...
export function RecommendSuccessScreen({
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-full flex-col items-center justify-center">
        ...
        >
          ...
          >
            ...
            {/* Awaiting review: the submission is pending, not live yet */}
            <p className="w-full font-inter text-sm font-medium leading-[17px] text-content-heading">
            ...
            computeSealTier(seal.verificationMethod, seal.hasCertificate, {
              ...
              >
                <ProofTierCard
                  ...
                  noGambling={seal.noGambling}
                  noPork={seal.noPork}
                  verificationMethod={seal.verificationMethod}
                />
              </motion.div>
            )}
      ...
      <div className="-mt-8 flex w-full flex-col items-center px-6 pb-8">
        <motion.div
          animate={{ opacity: 1, y: 0 }}
          className="w-full max-w-[345px]"
          initial={{ opacity: 0, y: 20 }}
          transition={
            prefersReducedMotion ? { duration: 0 } : { duration: 0.4, delay: 0.7, ease: 'easeOut' }
          }
        >
          <PWAInstallCTA />
        </motion.div>
