...
export function QuoteCard({
  ...
  return (
    <figure
      ...
      className={`hide-scrollbar relative flex aspect-[3/4] w-full max-w-[800px] flex-col items-center justify-center overflow-x-auto overflow-y-hidden rounded-2xl bg-primary px-6 py-12 shadow-lg sm:aspect-auto sm:rounded-3xl sm:px-8 md:rounded-[2.5rem] md:px-16 md:py-12 ${className ?? ''}`}
    >
      {/* Top Ornament */}
