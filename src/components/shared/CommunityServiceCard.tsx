        ...
        <div className="absolute right-0 top-0 flex flex-col items-end p-[6.49px] w-[160px] h-[36.97px]">
          ...
          >
            <Icon 
              ...
              icon={isSelected ? "material-symbols:close-rounded" : "material-symbols:add-rounded"} 
            />
          </button>
        </div>
        
        {/* Category Frame - Bottom Left */}
        {category && (
          <div className="absolute left-0 bottom-0 flex flex-col justify-end items-start p-[6.49px] w-[160px] h-[32.85px]">
            <div className="flex items-center justify-center px-2 py-1 w-[113px] h-[22px] bg-white/70 border border-[#CDCDCD] backdrop-blur-[1.24px] rounded-[5.96px]">
              <span className="font-inter-tight text-sm font-medium text-[#232323] leading-[13px] h-[14px] flex items-center text-center whitespace-nowrap">
                {category}
              </span>
            </div>
          </div>
      ...
      <div className="flex flex-col items-center p-2 w-[160px] h-[67.1px] bg-white border border-[#D4D4D4] rounded-b-2xl">
        <div className="flex flex-col items-start gap-2 w-[144px] h-[51.1px]">
          <div className="flex flex-col items-start gap-[1.5px] w-[144px] h-[19px]">
            <span className="font-inter-tight text-base font-semibold text-[#232323] leading-[19px] w-[144px] h-[19px]">
              {title}
            </span>
          </div>
          ...
          {donationCount && donationCount > 0 && (
            <div className="flex items-start gap-[5.73px] w-[94.19px] h-[16.1px]">
              <div className="flex justify-center items-center px-[3.1px] gap-[7.16px] w-[94.19px] h-[16.1px] rounded-[2.86px]">
                <span className="font-inter-tight text-[13px] font-normal text-[#232323] leading-[12px]">
                  {donationCount}x Gesponsort
                </span>
              </div>
            </div>
          )}
