export const en = {
  ...
  profile: {
    ...
    deleteAccountWarning:
      'Please note: Deletion is permanent – all your data will be completely and securely removed and cannot be recovered.',
    deleteAccountPrivacy:
      'Your account is never visible to others, and your privacy remains protected.',
  ...
  landing: {
    hero: {
      title:
        'From <span class="text-primary">Muslims</span><br class="block sm:hidden" /> for <span class="text-primary">Muslims</span>',
  ...
  about: {
    ...
    quotes: {
      ...
      third: {
        ...
        quote:
          'So we can find Muslim providers more easily and consciously spend our money with trust first within the Ummah.',
      },
    },
    continue: 'Continue',
  ...
  discovery: {
    resultsCount: {
      ...
      store: '{{count}} Stores',
      ummah: '{{count}} Community Services',
    },
  },
  search: {
  ...
  suchen: {
    ...
    nearMe: {
      ...
      permissionDeniedHintIos:
        'Location blocked. Open Settings → Privacy & Security → Location Services.',
      permissionDeniedHintAndroid: 'Location blocked. Allow access in your browser settings.',
      permissionDeniedHintFallback:
        'Location blocked. Please allow location access in your device settings.',
  ...
  providers: {
    ...
    noRecommendationsDescription:
      "You haven't recommended any providers yet. Recommend providers you know so others can find them.",
  ...
  create: {
    ...
    recommend: {
      ...
      userEmailDescription:
        'Only for follow-up questions or to inform you when your city is activated.',
      ...
      contactRequired:
        'Please provide at least one contact method (email, phone, website, or Instagram)',
      ...
      emailConsentText:
        'By providing your email, you consent to it being stored to receive follow-up about this recommendation.',
    },
    importOsm: {
    ...
    offers: {
      ...
      similarEntriesDialog:
        'Similar entries found: {{similarNames}}\n\nDo you still want to create "{{query}}"?',
    ...
    media: {
      ...
      socialInitiativesDescription:
        'Select social initiatives you support. Once the responsible parties of the initiatives verify this, your offer will be linked with the initiatives.',
  ...
  saved: {
    ...
    noSavedProvidersDescription:
      "You haven't saved any providers yet. Save providers to see them here.",
  ...
  editProvider: {
    ...
    editOffers: {
      ...
      description:
        'Select your offers or create new ones to receive matching requests - inshaAllah.',
  ...
  waitlist: {
    title: 'Join the Flow',
    description:
      'Help build the first marketplace for Muslims. Join the waitlist and secure early access.',
    ...
    successDescription:
      "Confirm your email to secure your spot. We'll notify you as soon as Ummah Flow launches.",
    successMessage:
    ...
    cityEarlyAccess: {
      ...
      description:
        '{{city}} grows in Early Access step by step together with the Ummah. Every recommendation helps make Muslim offerings visible.',
  ...
  providerDetail: {
    ...
    attestation: {
      ...
      subtitleFallback:
        'The provider has not yet left any proof. Please ask before your first visit whether they:',
    ...
    proofTier: {
      ...
      tier2Detail:
        'We visited this restaurant and spoke with the owner to confirm halal practices.',
      ...
      summaryGoldCert:
        'This provider was checked {{highlight}}on-site{{/highlight}} and has provided a {{highlight}}Halal certificate{{/highlight}}.',
      summaryGoldCertOnly:
        'This provider was checked {{highlight}}online{{/highlight}} and has provided a {{highlight}}Halal certificate{{/highlight}}.',
    ...
    halal: {
      ...
      description:
        'A restaurant is only listed if it offers no alcohol, no prohibited meat, and no gambling. The meat must be slaughtered halal.',
      learnMore: 'Learn more',
    },
    popup: {
      closeAria: 'Close',
