export const ar = {
  ...
  profile: {
    ...
    deleteAccountWarning:
      'يرجى ملاحظة: الحذف دائم – سيتم إزالة جميع بياناتك بشكل كامل وآمن ولا يمكن استعادتها.',
  ...
  landing: {
    hero: {
      title:
        'من <span class="text-primary">المسلمين</span><br class="block sm:hidden" /> إلى <span class="text-primary">المسلمين</span>',
  ...
  about: {
    ...
    quotes: {
      ...
      third: {
        ...
        quote:
          'حتى نتمكن من العثور على مزودي المسلمين بسهولة أكبر وإنفاق أموالنا بثقة ووعي أولاً داخل الأمة.',
      },
    },
    continue: 'التالي',
    discover: 'اكتشف أمتك',
  ...
  providers: {
    ...
    noRecommendationsDescription:
      'لم تقم بتوصية أي مزودين بعد. أوصِ بالمزودين الذين تعرفهم حتى يتمكن الآخرون من العثور عليهم.',
  ...
  create: {
    ...
    recommend: {
      ...
      contactRequired:
        'يرجى تقديم طريقة اتصال واحدة على الأقل (البريد الإلكتروني، الهاتف، الموقع الإلكتروني أو إنستغرام)',
      ...
      emailConsentText:
        'من خلال تقديم بريدك الإلكتروني، أنت توافق على تخزينه لتلقي متابعة حول هذه التوصية.',
    },
    importOsm: {
    ...
    offers: {
      ...
      similarEntriesDialog:
        'تم العثور على إدخالات مشابهة: {{similarNames}}\n\nهل لا تزال تريد إنشاء "{{query}}"؟',
    ...
    media: {
      ...
      socialInitiativesDescription:
        'اختر المبادرات الاجتماعية التي تدعمها. بمجرد أن تتحقق الأطراف المسؤولة عن المبادرات من ذلك، سيتم ربط عرضك بالمبادرات.',
  ...
  waitlist: {
    ...
    successMessage:
      'سنخطرك بمجرد إطلاقنا. في هذه الأثناء، لا تتردد في مشاركة UmmahFlow مع الآخرين.',
    ...
    cityEarlyAccess: {
      ...
      description:
        '{{city}} تنمو في الوصول المبكر خطوة بخطوة مع الأمة. كل توصية تساعد في جعل العروض الإسلامية مرئية.',
      changeCity: 'غيّر المدينة',
  ...
  providerDetail: {
    ...
    attestation: {
      ...
      subtitleFallback:
        'لم يضف مقدم الخدمة أدلة حتى الآن. يرجى الاستفسار قبل زيارتك الأولى عمّا إذا كان:',
    ...
    proofTier: {
      ...
      summaryGoldCert:
        'تم التحقق من هذا المزود {{highlight}}ميدانياً{{/highlight}} وقدّم {{highlight}}شهادة حلال{{/highlight}}.',
      summaryGoldCertOnly:
        'تم التحقق من هذا المزود {{highlight}}عبر الإنترنت{{/highlight}} وقدّم {{highlight}}شهادة حلال{{/highlight}}.',
      ...
      explanation:
        'كل إدراج في Ummah Flow يفي بمتطلبات الحلال لدينا. مستوى الثقة يوضح مدى دقة تأكيدنا لذلك.',
    },
    trustBadges: {
      muslimOwned: 'مسلم',
    ...
    halal: {
      ...
      description:
        'لا يتم إدراج أي مطعم إلا إذا كان لا يقدّم الكحول ولا اللحوم المحرمة ولا القمار. ويجب أن يكون اللحم مذبوحًا على الطريقة الحلال.',
      learnMore: 'اعرف المزيد',
    },
    popup: {
      closeAria: 'إغلاق',
