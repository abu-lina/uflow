export const de = {
  ...
  landing: {
    hero: {
      title:
        'Von <span class="text-primary">Muslimen</span><br class="block sm:hidden" /> für <span class="text-primary">Muslime</span>',
  ...
  about: {
    ...
    quotes: {
      first: {
        ...
        quote:
          'Entdecke muslimische Anbieter in deiner Stadt – von Lebensmitteln bis zu Dienstleistungen.',
      },
      second: {
      ...
      third: {
        ...
        quote:
          'Damit wir muslimische Anbieter leichter finden und unser Geld mit Vertrauen bewusst zuerst innerhalb der Ummah ausgeben.',
      },
    },
    continue: 'Weiter',
    ...
    filter: {
      ...
      items: {
        ...
        familien: {
          ...
          subtitle: 'Geeignet für Familien',
        },
        frauen: {
          title: 'Frauenfreundlich',
          subtitle: 'Frauenfreundliches Angebot',
        },
        kinder: {
          title: 'Kinderfreundlich',
          subtitle: 'Geeignet für Kinder',
        },
      },
      ummahItems: {
        kostenlos: {
  ...
  providers: {
    ...
    noRecommendationsDescription:
      'Du hast noch keine Provider empfohlen. Empfehle Provider, die du kennst, damit andere sie finden können.',
  ...
  create: {
    ...
    recommend: {
      ...
      contactRequired:
        'Bitte gib mindestens eine Kontaktmöglichkeit an (E-Mail, Telefon, Website oder Instagram)',
      successTitle: 'BarakAllahu feek',
      successDescription:
        'Dein Vorschlag hilft, muslimische Anbieter in deiner Stadt sichtbar zu machen.',
      recommendAnother: 'Weiteren Anbieter empfehlen',
      backToOverview: 'Zurück zur Übersicht',
      emailConsentText:
        'Durch die Angabe Ihrer E-Mail-Adresse stimmen Sie der Speicherung zu, um Nachfragen zu dieser Empfehlung zu erhalten.',
    },
    importOsm: {
    ...
    offers: {
      ...
      rateLimitExceeded:
        'Rate-Limit überschritten. Bitte versuchen Sie es in {{seconds}} Sekunden erneut.',
  ...
  saved: {
    ...
    noSavedProvidersDescription:
      'Du hast noch keine Anbieter gespeichert. Speichere Anbieter, um sie hier zu sehen.',
    ...
    errorLoadingDescription:
      'Gespeicherte Inhalte konnten nicht geladen werden. Bitte versuche es erneut.',
  ...
  login: {
    ...
    emailNotConfirmed:
      'Bitte überprüfe deine E-Mail und bestätige deine Registrierung vor der Anmeldung.',
    emailNotFound: 'Diese E-Mail-Adresse ist nicht registriert. Bitte erstelle zuerst ein Konto.',
    invalidCredentials: 'Ungültige E-Mail oder Passwort. Bitte versuche es erneut.',
    loginFailedToast: 'Anmeldung fehlgeschlagen',
    loginFailedDescription: 'Bitte überprüfe deine Anmeldedaten und versuche es erneut.',
  ...
  forgotPassword: {
    ...
    emailNotFound:
      'Diese E-Mail-Adresse ist nicht registriert. Bitte überprüfe deine Eingabe oder erstelle ein Konto.',
  ...
  legal: {
    ...
    consentRequired:
      'Sie müssen den Allgemeinen Geschäftsbedingungen und der Datenschutzrichtlinie zustimmen, um ein Konto zu erstellen',
  ...
  waitlist: {
    ...
    description:
      'Hilf mit, den ersten Marktplatz für Muslime aufzubauen. Trage dich in die Warteliste ein und sichere dir frühen Zugang.',
    ...
    successDescription:
      'Bestätige deine E-Mail, um deinen Platz zu sichern. Wir informieren dich, sobald Ummah Flow startet.',
    successMessage:
      'Wir benachrichtigen dich, sobald wir starten. In der Zwischenzeit kannst du UmmahFlow gerne mit anderen teilen.',
    ...
    errorConsentRequired:
      'Sie müssen den Allgemeinen Geschäftsbedingungen und der Datenschutzrichtlinie zustimmen',
    ...
    providerModalDescription:
      'Sag uns kurz Bescheid, damit wir dich beim Start besser unterstützen können.',
    ...
    earlyAccess: {
      ...
      homeDescription:
        'Ummah Flow befindet sich im Early Access.  Noch sind nicht alle Städte und Anbieter vertreten – genau das bauen wir gerade gemeinsam auf.',
      ...
      errorMarkingSeen:
        'Fehler beim Aktualisieren des Status. Dies beeinträchtigt deine Erfahrung nicht.',
      retry: 'Erneut versuchen',
    ...
    citySelection: {
      title: 'Deine Stadt',
      subtitle:
        'Wähle eine Stadt, um muslimische Anbieter in deiner Umgebung zu entdecken.\nDer Ausbau erfolgt stadtweise – Schritt für Schritt.',
    ...
    cityEarlyAccess: {
      ...
      description:
        '{{city}} wächst im Early Access Schritt für Schritt gemeinsam mit der Ummah. Jede Empfehlung hilft, muslimische Angebote sichtbar zu machen.',
      suggestProvider: 'Anbieter vorschlagen',
  ...
  providerDetail: {
    ...
    openStatus: {
      open: 'Geöffnet',
      closed: 'Geschlossen',
      untilOpen: 'Bis {{time}} Uhr geöffnet',
      opensTomorrow: 'Öffnet um {{time}} Uhr morgen',
      opensOnDay: 'Öffnet um {{time}} Uhr am {{day}}',
    },
    amenities: {
      muslimOwned: 'Muslim Owned',
      prayerSpace: 'Gebetsraum',
      parking: 'Parkplätze',
      noAlcohol: 'Kein Alkohol',
      noPork: 'Kein Schweinefleisch',
      familyFriendly: 'Familienfreundlich',
      womenFriendly: 'Frauenfreundlich',
    ...
    attestation: {
      ...
      subtitleFallback:
        'Der Anbieter hat bisher noch keine Nachweise hinterlegt. Bitte informiere euch vor dem ersten Besuch ob:',
    ...
    proofTier: {
      ...
      tier1Detail:
        'Halal-Kriterien vor der Aufnahme über Speisekarte und Online-Recherche bestätigt.',
      tier2Title: 'Vor-Ort geprüft',
      tier2Detail:
        'Wir haben dieses Restaurant besucht und mit dem Inhaber über die Halal-Praktiken gesprochen.',
      ...
      summaryGoldCert:
        'Dieser Anbieter wurde {{highlight}}Vor Ort{{/highlight}} geprüft und hat ein {{highlight}}Halal-Zertifikat{{/highlight}} nachgewiesen.',
      summaryGoldCertOnly:
        'Dieser Anbieter wurde {{highlight}}Online{{/highlight}} geprüft und hat ein {{highlight}}Halal-Zertifikat{{/highlight}} nachgewiesen.',
      whatWeVerified: 'Was wir geprüft haben',
      checkMenuReviewed: 'Speisekarte online geprüft',
      checkMenuReviewedOnsite: 'Vor Ort geprüftes Menü',
      checkSellsNoAlcohol: 'Verkauft kein Alkohol',
      checkSellsNoPork: 'Verkauft kein Schweinefleisch',
      checkClaimsMeatHalal: 'Behauptet, Fleisch sei halal',
      checkSellsProcessNoAlcohol: 'Verkauft und verarbeitet kein Alkohol',
      checkSellsProcessNoPork: 'Verkauft und verarbeitet kein Schweinefleisch',
      checkMeatIsHalal: 'Fleisch ist halal',
    ...
    container: {
      addressTapToNavigate: 'Adresse antippen zum Navigieren',
      online: 'Online',
      shareProviderAria: 'Provider teilen',
      back: 'Zurück',
      website: 'Website',
      call: 'Anrufen',
      share: 'Teilen',
      ...
      selectImage: 'Bild {{index}} auswählen',
      imageGalleryAria: '{{name}} Bildgalerie mit {{count}} Bildern',
      goToImageAria: 'Gehe zu Bild {{index}} von {{total}}',
      toastLinkCopied: 'Link in Zwischenablage kopiert!',
      toastCopyLinkError: 'Fehler beim Kopieren des Links',
      toastNoPhone: 'Keine Telefonnummer verfügbar',
      toastPhoneCopied: 'Telefonnummer kopiert: {{phone}}',
      toastOpenPhoneError: 'Fehler beim Öffnen der Telefonnummer',
    },
  },
  welcome: {
  ...
  submissionValidation: {
    ...
    emailConsentRequired: 'Bitte stimme der Speicherung deiner E-Mail-Adresse zu.',
    emailConsentLabel:
      'Ich stimme zu, dass meine E-Mail-Adresse gespeichert wird, um mich zum Status meiner Empfehlung zu kontaktieren. Details in der',
  },
} as const;
