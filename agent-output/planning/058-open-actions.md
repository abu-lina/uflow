...
| --- | --- | --- | --- | --- |
| Run `--audit-stale-clone` against production and save the overlap report | DevOps operator / Admin | Immediately after deployment of `v0.8.27`, before any provenance write run | Terminal output or saved report showing exact duplicates / partial overlaps / unique rows and the recommendation block | Open |
