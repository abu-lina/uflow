-- Plan 204: Include category fields in near-me food search results so
-- ProviderCard can render the localized category badge instead of fallback
-- "unnamed" when near-me mode is active.
...
COMMENT ON FUNCTION public.search_food_near_me IS
  'Plan 204: Returns approved food providers within a radius (km, capped at 25) of a point, '
  'nearest-location-per-provider, distance-ordered with category metadata for near-me cards. '
  'opening_hours returned raw for client-side open-now filtering.';
