-- =====================================================
-- ADD RECOMMENDER EMAIL COLUMNS
-- =====================================================
-- This migration adds recommender_email columns to providers
-- and community_services tables to store email addresses of
-- anonymous users who recommend providers/services.
-- Required for GDPR compliance when collecting personal data.
-- =====================================================
...
-- Add indexes for queries (partial index on non-null values for performance)
...
-- Add documentation comments for GDPR compliance
