-- ============================================================
-- Migration: Fix nullable string fields using COALESCE
-- Date: 2026-08-31
-- Problem: COALESCE(v_providers->>'col', col) prevents clearing
--   nullable string fields (website, instagram, email, phone,
--   address, description). When the caller sends null, JSONB
--   ->> returns SQL NULL, and COALESCE falls back to the old
--   value. Replace with CASE WHEN ... ? ... to distinguish
--   "caller wants to set this field" from "caller omitted it".
-- ============================================================
