-- ============================================================
-- Migration: Plan 165 — Add show_address to admin_update_provider RPC
-- Date: 2026-06-12
-- Adds show_address column to the providers UPDATE section
-- of the admin_update_provider RPC function.
-- ============================================================
...
COMMENT ON FUNCTION public.admin_update_provider IS
  'Plan 165: Atomic multi-table update for provider edit page. Accepts JSONB payload with providers, food_providers, store_providers, menu_items, delivery_links, community_service_ids, and locations sub-objects. Locations use upsert pattern to preserve existing IDs.';
